...
public class OnlineError extends Exception {

	public OnlineError(String message) {
		super(message);
	}

	public OnlineError(Throwable cause) {
		super(cause);
	}

	public OnlineError(String message, Throwable cause) {
		super(message, cause);
	}
}
